...
function save(name, content) {
  fs.writeFile(`${name}.js`, `let ${name} = ${JSON.stringify(content)};"undefined"!=typeof module&&null!=module&&(module.exports=${name});`, function(err) {
    if(err) {
...
(() => {
  ...
  _.forEach(master.mstSvt, mstSvt => {
